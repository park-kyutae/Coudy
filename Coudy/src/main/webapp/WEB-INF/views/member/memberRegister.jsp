...
<div class="input-form">
	...
	<div class="form-floating mb-3">
		<form:password path="passwd" class="form-control" autocomplete="new-password" placeholder="passwd"/>
...
<div class="col-12 input-form">
	    <button class="btn btn-primary" id="register_submit" type="submit" style="width:50%;border-radius: 5px 0 0 5px;">가입하기</button>
